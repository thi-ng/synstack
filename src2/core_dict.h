...
char *ctss_vm_core_dict =
    ""
    ": 'lit lit lit push-dict ;" NL ": 'push-dict lit push-dict push-dict ;" NL
    ...
    ": else compile> branch dict-here 0 push-dict save-else-offset ; "
    "immediate!" NL
    ...
    ": recur compile> branch latest 2 + dict-here - push-dict ; immediate!";
